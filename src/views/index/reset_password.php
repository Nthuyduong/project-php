            ...
            <div class="row mt-60 mt-40">
                ...
                <div class="col-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="inpu" type="text" name="remail" id="remail" required>
                    </div>
                    <div>
                        <label for="psw">Re-type password</label>
                        <input class="inpu" type="password" name="repass" id="repass" required>
                    </div>
                    <button type="submit" class="btn btn-pri my-4 w-100" name="b1" id="id" value="Dong y">Reset password</button>
                    <div>
